...
GLuint cubeVAO, VBO;
GLuint lambVAO;
glm::vec3 lambPos(1.2f, 1.0f, 2.0f);

// camera
Camera camera(glm::vec3(0.0f, 0.0f, 3.0f));
float lastX = WIN_WINDTH / 2.0f;
...
const string vertexLambShaderPath = "Shader/light_vt.shader";
const string fragmentLambShaderPath = "Shader/light_fg.shader";
